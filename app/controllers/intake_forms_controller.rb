class IntakeFormsController < ApplicationController
  ...
  def intake_form_params
    params.require(:intake_form).permit(:immediate_danger, :name, :gender, :age_range, :location, :place_to_sleep, :needs_medical_attention, :children, :lgbtq, :hiv, :abuse_victim)
  end
end
